...
//   // Filter ONLY success transactions + sort latest first
//   const successfulTransactions = React.useMemo(() => {
//     if (!data?.data || data.data.length === 0) return [];

//     return data.data
//       .filter((t: any) => t.status === 2) // Only success
//       .sort((a: any, b: any) => {
//         const dateA = parseIndianDate(a.date_ist || "");
//         const dateB = parseIndianDate(b.date_ist || "");
...
//   // Use the accurate totalUsed from backend (successful uses only)
...
//             </div>
//             <div>
//               <h2 className="text-2xl font-bold">Coupon Users Success</h2>
//               <Badge variant="outline" className="mt-2 text-lg px-4 py-1 font-mono">
//                 {couponCode}
//               </Badge>
//             </div>
